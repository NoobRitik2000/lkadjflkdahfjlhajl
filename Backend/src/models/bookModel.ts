...
Book.init({
    ...
    available_copies: {
        ...
        allowNull: false,
        field: 'available_copies' // Match the column name in the database

    },
    total_copies: {
        type: DataTypes.INTEGER,
        allowNull: false,
        field: 'total_copies' // Match the column name in the database

    },
    created_at: {
        type: DataTypes.DATE,
        defaultValue: DataTypes.NOW,
        field: 'created_at' // Ensure this matches your database column
